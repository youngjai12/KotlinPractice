...
class PriceScheduleManager(
    ...
    val AVAILABLE_ACCT = userAccessInfoRepository.getAvailableAcctIdList()
    companion object{
        val CHUNK_SIZE = 15
    ...
    private fun stockAssignAlgorithm(availableAcct: List<String>, stockList: List<Stock>) {
        val perAssignedCnt = floor(MIXED_STOCK_SAMPLE.size.toDouble() / availableAcct.size.toDouble()).toInt()
